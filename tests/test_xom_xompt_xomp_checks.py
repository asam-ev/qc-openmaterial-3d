...
from qc_openmaterial3d.checks import xom_xompt_checker, xom_xomp_checker

# --- tables_sorted_correctly ---

TABLES_SORTED_RULE_UID = "asam.net:xom:1.0.0:xompt.tables_sorted_correctly"
TABLES_SORTED_CHECKER_ID = xom_xompt_checker.tables_sorted_correctly.CHECKER_ID
...
UNIQUE_WL_RULE_UID = "asam.net:xom:1.0.0:xomp.look_up_tables_unique_wavelengths"
UNIQUE_WL_CHECKER_ID = xom_xomp_checker.look_up_tables_unique_wavelengths.CHECKER_ID
